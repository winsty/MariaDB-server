        ...
        | json_on_response ON json_empty_or_error json_opt_on_empty_or_error
          {
            ...
            {
              if (Lex->json_table->m_cur_json_table_column->m_on_empty.specified())
              {
                my_error(ER_JSON_TABLE_DOUBLE_ON_RESPONSE, MYF(0), "EMPTY");
              }
              Lex->json_table->m_cur_json_table_column->m_on_empty= $1;
            }
            else /* ON_ERROR */
            {
              if (Lex->json_table->m_cur_json_table_column->m_on_error.specified())
              {
                my_error(ER_JSON_TABLE_DOUBLE_ON_RESPONSE, MYF(0), "ERROR");
              }
