...
@param[in] filename_hash - offset to the auto_event_names corresponding to the
...
{
   ut_ad(filename_hash >= 0 && filename_hash < NKEYS);
   return auto_event_keys[filename_hash];
}
